...
let cost=parseInt(prompt("Quel est le montant des achats ?"));
let child=parseInt(prompt("Quel est le nombre d'enfants(s) dans la famille ?"));
let reduction;
let discount;
...
console.log(`Le montant de la réducion est de ${discount}€`);